...
public class ImageUtils {
	...
	public static void resize(String srcFilePath, String destFile, int width) throws Exception {
		resize(srcFilePath, destFile, width, width, -1, -1);
	}
    ...
    public static void makeRoundedCorner(File srcFile, File destFile, int cornerRadius) throws Exception {
        ...
        try {
            ...
            FileUtils.forceMkdir(new File(destFile.getParentFile().getAbsolutePath()));
